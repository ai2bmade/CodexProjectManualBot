...
const ui = {
  ...
  ko: {
    ...
    completed: "완료한 레슨",
    available: "이용 가능한 레슨",
    markedDone: "레슨 완료로 기록되었습니다.",
    doneUsage: "레슨을 마친 뒤 /done 0 형식으로 입력해 주세요. 0 자리에 레슨 번호를 넣으면 됩니다.",
    doneReminder: "레슨을 마치면 /done {{lessonId}} 를 입력해 주세요.",
    unlock:
      "레슨 0, 1, 2는 무료입니다.\n\n전체 20개 실습 레슨은 $3에 열 수 있습니다. 이 봇은 학생의 모든 메시지마다 AI를 호출하지 않고, 구조화된 매뉴얼 방식으로 운영되어 비용을 낮추고 있습니다.",
    ...
    lessonLabel: "레슨",
    stepHeader: "현재 단계",
    lessonOutline: "이번 레슨의 순서",
    bigPicture: "이 레슨의 목적과 배경",
    thisLesson: "이번 레슨에서 할 일",
    taskLabel: "이 레슨이 끝나면 확인할 내용",
    stepPrompt: "ChatGPT 또는 Codex에 붙여 넣기",
    mediaLabel: "선택 사항 미디어 아이디어",
    buttonNext: "완료/다음 단계",
    buttonRepeat: "현재 단계 다시 보기",
    buttonLessonZero: "레슨 0",
    buttonLessons: "레슨 목록"
  },
  es_419: {
